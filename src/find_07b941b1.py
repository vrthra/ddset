...
def my_predicate(src):
    ...
    o = I.do('find', 'sudo docker exec -it %s bash -c' % I.docker(), "./find13/find/find/%s" % src, True)
    os.system("stty sane")
    out = o.stdout
...
if __name__ == '__main__':
    I.main('./lang/find/grammar/grammar.json', './lang/find/bugs/find.07b941b1', my_predicate)
