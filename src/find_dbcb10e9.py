...
def my_predicate(src):
    ...
    o = I.do('find', 'sudo docker exec -it 1c0f1a39c84b bash -c', "./find10/find/find/%s" % src, True)
    os.system("stty sane")
    out = o.stdout
...
if __name__ == '__main__':
    I.main('./lang/find/grammar/grammar.json', './lang/find/bugs/find.dbcb10e9', my_predicate)
