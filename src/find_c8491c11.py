...
def my_predicate(src):
    ...
    o = I.do('find', 'sudo docker exec -it %s bash -c' % I.docker(), "./find11/find/find/%s" % src, True)
    os.system("stty sane")
    out = o.stdout
...
if __name__ == '__main__':
    I.main('./lang/find/grammar/grammar.json', './lang/find/bugs/find.c8491c11', my_predicate)
